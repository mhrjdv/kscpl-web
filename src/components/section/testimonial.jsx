...
const testimonialData = [
    {
        ...
        review: "I was truly impressed by the design expertise of Kalpana Struct-Con. They turned my home into a stylish haven, and I couldn't be happier!"
    },
    {
        id: 2,
        name: "John Smith",
        position: "Smith & Co. Architecture.",
        review: "Kalpana Struct-Con exceeded my expectations. They took my vision and brought it to life, creating a breathtaking design that perfectly complements my"
    },
    {
        id: 3,
        name: "Emily Roberts",
        position: "UrbanLiving Interiors",
        review: "Kalpana Struct-Con Interiors transformed my office space into a functional yet aesthetically pleasing environment. Their attention to detail and innovative designs are top-notch"
    },
    {
        id: 4,
        name: "Sarah Johnson",
