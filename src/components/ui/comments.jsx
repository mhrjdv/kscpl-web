        ...
        <div className='grid 2xl:grid-cols-[auto_25%] lg:grid-cols-[auto_32%] 2xl:gap-[143px] lg:gap-16 pb-20'>
            <div>
                ...
                <div className='flex 2sm:gap-7.5 gap-4'>
                    <Link href={""}>
                        <Image src={team_1} loading='lazy'  placeholder='blur' blurDataURL={staticBluarDataUrl} alt='Philip Reyes' className='max-w-20 max-h-20 object-cover' />
                    </Link>
                    <div>
                ...
                <div className='flex 2sm:gap-7.5 gap-4 2sm:ml-28 ml-10 pt-10'>
                    <Link href={""}>
                        <Image src={team_2} loading='lazy'  placeholder='blur' blurDataURL={staticBluarDataUrl} alt='Philip Reyes' className='max-w-20 max-h-20 object-cover' />
                    </Link>
                    <div>
