...
const ProjectCardOneRealty = ({ order, position, project_year, project_desc, project_img, location, project_type, project_name, link, imageVariants, cardVariants }) => {
...
export default ProjectCardOneRealty;