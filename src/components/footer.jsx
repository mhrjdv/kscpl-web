            ...
            <div className=' bg-secondary '>
                <div className='container'>
                    <div className='grid lg:grid-cols-3 grid-cols-1 items-center pt-[100px] pb-20'>
                        ...
                        <div className='mt-12 lg:mt-0 flex gap-x-10'>
                            ...
                            <div>
                                ...
                                <div className=''>
                                    <p className='text-xl font-bold text-primary-foreground'>Kalpana Struct-Con, </p>
                                ...
                                <div className='mt-[17px]'>
                                    ...
                                    <Link href={"mailto:hello@Kalpana Struct-Con.com"} className='text-lg block text-primary-foreground hover-underline'>Email: <span>hello@Kalpana Struct-Con.com</span></Link>
                                </div>
                            </div>
                        </div>
                        <div className='mt-12 lg:mt-0 flex gap-x-10'>
                            ...
                            <div>
                                ...
                                <div className='mt-[18px]'>
                                    <p className='text-xl font-bold text-primary-foreground'>Kalpana Struct-Con Inc, </p>
                                ...
                                <div className='mt-[17px]'>
                                    <Link href={"tel:+34962398486"} className='text-lg block text-primary-foreground hover-underline' >Phone: <span>+91 9999999999</span></Link>
                                    <Link href={"mailto:hello@Kalpana Struct-Con.com"} className='text-lg block text-primary-foreground hover-underline'>Email: <span>info@kscpl.com</span></Link>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='py-8 lg:flex justify-between items-center'>
                        <span className='text-sm text-primary-foreground block'>Developed by <Link href={"https://www.futurescapeadvertising.com/"}>Futurescape Advertising</Link> </span>
                        <span className='text-sm text-primary-foreground block mt-3 lg:mt-0'>©2024, Kalpana Struct-Con, All Rights Reserved</span>
                    </div>
                </div>
            </div>
        </footer>
