...
export const metadata = {
  title: "Kalpana Struct-Con -- Career",
    ...
    <>
      <section>
        <div className='container-fluid '>
          <SectionTitle
            ...
            sectionDesc={"Discover Your Future at Kalpana Struct-Con: Where Innovation Meets Passion"}
          />
        </div>
      ...
      <section className='pt-20'>
        <div className='container-fluid '>
          <SectionTitle
            sectionName={"Why"}
            sectionTitle={"Why Join Kalpana Struct-Con"}
            sectionDesc={"Discover Your Future at Kalpana Struct-Con: Where Innovation Meets Passion"}
          />
