    ...
    async function fetchProjects() {
      try {
        ...
        const formattedProjects = data.data.map((item) => {
          ...
          // Build the link: e.g. /construction/Institutional/cyber-one-Institutional-building
          // Make sure Category is "Institutional" if it's truly Institutional
          const categorySlug = (Category || "").toLowerCase(); // "Institutional"
      ...
      <section>
        <div className="container-fluid pt-20">
          <p className="text-red-600">
            Failed to load Institutional projects: {error}
          </p>
        </div>
      </section>
    );
