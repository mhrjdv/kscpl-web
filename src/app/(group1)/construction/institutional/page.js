      ...
      <div className="lg:pt-30 2sm:pt-20 pt-14">
        <div>
          {projects.map(({ id, projectDetails }) => {
            const { Title, MainImage, slug, Category, Description, Location, Duration } = projectDetails;
            ...
            return (
              <ProjectCardOne
                ...
                position={id % 2 === 0 ? "lg:absolute lg:right-0 lg:top-1/2 lg:-translate-y-1/2" : "lg:absolute lg:left-0 lg:top-1/2 lg:-translate-y-1/2"}
                imageVariants={id % 2 === 0 ? cardSlideAnimationRight() : cardSlideAnimation()}
                cardVariants={id % 2 === 0 ? cardSlideAnimationRightDelay() : cardSlideAnimationDelay()}
              />
            );
          })}
        </div>
