...
export const metadata = {
  title: "Kalpana Struct-Con -- Team Single",
          ...
          <div className='grid xl:grid-cols-[auto_538px] lg:grid-cols-[auto_350px] md:grid-cols-[auto_400px] 2xl:gap-[132px] gap-16 items-start'>
            <div>
              <div className='mb-12.5'>
                ...
                <p>Russell Otten, the Interior Alchemist at Kalpana Struct-Con, adds a touch of magic to spaces. With over a decade of experience, Russell blends artistic flair with a deep understanding of client aspirations.</p>
              </div>
              ...
              <div className='pt-20'>
                ...
                <ul>
                  <li>
                    ...
                    <p className='mt-2.5 xl:ml-[113px] 2sm:ml-14 ml-10'>Russell's design philosop Kalpana Struct-Con revolves around capturing the essence of each client's persionality and translating it into a space that feels uniquely theirs.</p>
                  </li>
                  <li className='pt-7.5'>
              ...
              <div className='pt-20'>
                ...
                <ul>
                  <li>
                    ...
                    <p className='mt-2.5 xl:ml-[113px] 2sm:ml-14 ml-10'>Russell holds a Master's in Interior of the Design from Kalpana Struct-Con University of Belgium.</p>
                  </li>
                  <li className='pt-7.5'>
              ...
              <div className='pt-20'>
                ...
                <ul>
                  <li>
                    ...
                    <p className='mt-2.5 xl:ml-[113px] 2sm:ml-14 ml-10'>Russell Otten's work at Kalpana Struct-Con has been feeatured in Design Excellence Magazine, earning him the Interior Alchemist title.</p>
                  </li>
              ...
              <div className='pt-20'>
                ...
                <ul>
                  <li className='flex items-center mb-3'>
                    ...
                    <Link href={"mailto:russell@Kalpana Struct-Con.com"} className='hover-underline' ><span>russell@Kalpana Struct-Con.com</span></Link>
                  </li>
                  <li className='flex items-center mb-3'>
